/*
 * cardtest3.c - this will check that council_room correctly allowed all players to draw cards
 */
...
int main () {
	...
	if(G.handCount[1] == 1)//this game does not draw cards till  thke start of the players turn
